...
export const Top5Reel: React.FC = () => {
  ...
  console.log("[Top5Reel] allEntries count:", allEntries.length);
  console.log("[Top5Reel] rankings count:", rankings.length);
  rankings.forEach((r, i) => {
    console.log(
      `[Top5Reel] ranking[${i}]: rank=${r.rank}, movie="${r.movieTitle}", ` +
  ...
  console.log("[Top5Reel] CARD_FRAMES:", CARD_FRAMES, "FPS:", FPS);
  console.log("[Top5Reel] segmentStarts:", JSON.stringify(segmentStarts));
  console.log("[Top5Reel] total cursor (end frame):", cursor);
  ...
  console.log("[Top5Reel] clipRanges for ducking:", JSON.stringify(clipRanges));
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#000" }}>
      ...
      {rankings.map((r, i) => {
        ...
        console.log(
          `[Top5Reel] RENDER rank=${r.rank}: segFrom=${segFrom}, clipDur=${clipDur}, ` +
                  ...
                  >
                    {videoPath && isVideoFile(videoPath) ? (
                      <OffthreadVideo
                        ...
                        onError={(e) => {
                          console.error(`[Top5Reel] OffthreadVideo ERROR rank=${r.rank}:`, e);
                        }}
                      />
                    ) : (
                      <Img
